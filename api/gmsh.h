...
//
// This file defines the Gmsh C++ API (v5.0.0).
//
...
#define GMSH_API_VERSION "5.0.0"
#define GMSH_API_VERSION_MAJOR 5
#define GMSH_API_VERSION_MINOR 0
...
namespace gmsh { // Top-level functions
  ...
  namespace model { // Model functions
    ...
    namespace mesh { // Mesh functions
      ...
      //
      // Get the type and node tags of the element with tag `elementTag', as well
      // as the dimension `dim' and tag `tag' of the entity on which the element is
